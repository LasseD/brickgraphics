...
public class LXFPrinter {
	...
	private static void writeHeaderBlock(PrintWriter pw, String fileNameNoExt) {
		...
		pw.println("  <Meta>");
		pw.println("    <Application name=\"" + MainWindow.APP_NAME + "\" versionMajor=\"" + MainWindow.VERSION_MAJOR + "\" versionMinor=\"" + MainWindow.VERSION_MINOR + "\"/>");
		pw.println("    <Brand name=\"" + MainWindow.APP_NAME_SHORT + "\"/>");
